...
rm -f 006.test_sample_format
clang++ -std=c++11 -o 006.test_sample_format ../../006.test_sample_format/006.test_sample_format.cpp -lpthread ${flags} && ./006.test_sample_format
#${build} && ${run}
