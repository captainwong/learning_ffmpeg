...
CmdutilResource g_cmdutil_resource = {};
...
static void (*program_exit)(int ret) = nullptr;
...
void init_opts(void)
{
    av_dict_set(&g_cmdutil_resource.sws_dict, "flags", "bicubic", 0);
}

void uninit_opts(void)
{
    av_dict_free(&g_cmdutil_resource.swr_opts);
    av_dict_free(&g_cmdutil_resource.sws_dict);
    av_dict_free(&g_cmdutil_resource.format_opts);
    av_dict_free(&g_cmdutil_resource.codec_opts);
    av_dict_free(&g_cmdutil_resource.resample_opts);
}
...
int opt_timelimit(void* optctx, const char* opt, const char* arg)
{
    ...
    struct rlimit rl = rlimit{ lim, lim + 1 };
...
int opt_default(void* optctx, const char* opt, const char* arg)
{
    ...
    if ((o = opt_find(&cc, opt_stripped, NULL, 0,
        ...
        av_dict_set(&g_cmdutil_resource. codec_opts, opt, arg, FLAGS);
        consumed = 1;
    }
    if ((o = opt_find(&fc, opt, NULL, 0,
                      AV_OPT_SEARCH_CHILDREN | AV_OPT_SEARCH_FAKE_OBJ))) {
        av_dict_set(&g_cmdutil_resource.format_opts, opt, arg, FLAGS);
        if (consumed)
    ...
    if (!consumed && (o = opt_find(&sc, opt, NULL, 0,
        ...
        av_dict_set(&g_cmdutil_resource.sws_dict, opt, arg, FLAGS);
    ...
    if (!consumed && (o = opt_find(&swr_class, opt, NULL, 0,
        ...
        av_dict_set(&g_cmdutil_resource.swr_opts, opt, arg, FLAGS);
        consumed = 1;
    }
#endif
#if CONFIG_AVRESAMPLE
                         ...
                         const char* arg)
{
    ...
    *g = octx->cur_group;
    ...
    g->sws_dict = g_cmdutil_resource. sws_dict;
    g->swr_opts = g_cmdutil_resource.swr_opts;
    g->codec_opts = g_cmdutil_resource.codec_opts;
    g->format_opts = g_cmdutil_resource.format_opts;
    g->resample_opts = g_cmdutil_resource.resample_opts;

    g_cmdutil_resource.codec_opts = NULL;
    g_cmdutil_resource.format_opts = NULL;
    g_cmdutil_resource.resample_opts = NULL;
    g_cmdutil_resource.sws_dict = NULL;
    g_cmdutil_resource.swr_opts = NULL;
    init_opts();
...
do {                                                                           \
    ...
    if (octx->cur_group.nb_opts || g_cmdutil_resource.codec_opts || g_cmdutil_resource.format_opts || g_cmdutil_resource.resample_opts)
