...
#define FFMPEG_CONFIGURATION "--prefix=/usr/local/ffmpeg --enable-debug=3 --disable-static --enable-shared --enable-libx264 --enable-filter=delogo --enable-gpl --enable-nonfree --enable-libfdk-aac --enable-libopus --enable-avresample"
